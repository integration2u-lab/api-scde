...
const serializeEnergyBalance = (record: EnergyBalance) => ({
  ...
  net: record.net ?? null,
  statusMeasurement: record.statusMeasurement ?? null,
...
const energyBalanceToPayload = (
  ...
  return {
    ...
    statusMeasurement: (pickFirst(body, ["statusMeasurement", "status_measurement"]) ?? record.statusMeasurement ?? null) as EnergyBalancePayload["statusMeasurement"],
